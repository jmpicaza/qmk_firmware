/*
 * compile: qmk compile -kb boardsource/4x12 -km pkz_4x12
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // │Shift│  Ω  │  ∑  │     │  √  │  ß  ││     │  µ  │  ,  │  .  │  -  │Shift│
    // ├─────┼─────┼─────┼─────┼─────┼─────┤├─────┼─────┼─────┼─────┼─────┼─────┤
    // │ RGB │ xxx │ Alt │Bcksp│Enter│Enter││     │Space│Delet│ xxx │ xxx │ xxx │
    // │Toogl│_ARRO│     │L ALT│Comm │     ││_MOUS│_SYMB│_LIGH│ xxx │ xxx │ xxx │
    // └─────┴─────┴─────┴─────┴─────┴─────┘└─────┴─────┴─────┴─────┴─────┴─────┘
   [_QWERTY_M] = LAYOUT_ortho_4x12(
    ...
    RGB_TOG,        TG(_ARROWS), KC_LALT, LALT_T(KC_BSPC),LGUI_T(KC_ENT), KC_ENT, /**/ TO(_MOUSE),SPACE_SYM,DEL_LIG, XXXXXXX, XXXXXXX,              XXXXXXX
  ),
  [_QWERTY_W] = LAYOUT_ortho_4x12(
    RALT_T(KC_ESC), KC_Q,        KC_W,    KC_E,           KC_R,           KC_T,   /**/ KC_Y,      KC_U,     KC_I,    KC_O,    KC_P,                 LGUI_T(KC_BSPC),
    LCTL_T(KC_TAB), KC_A,        KC_S,    KC_D,           F_MOU,          KC_G,   /**/ KC_H,      KC_J,     KC_K,    KC_L,    LT(_NUMBERS,KC_SCLN), KC_QUOT /*ENT_TIL*/,
    LSFT_T(KC_ENT), PSSW_Z,      KC_X,    KC_C,           KC_V,           KC_B,   /**/ KC_N,      KC_M,     KC_COMM, KC_DOT,  KC_SLSH,              RSFT_T(KC_BSLS),
    RGB_TOG,        TG(_ARROWS), KC_LALT, LALT_T(KC_BSPC),LCTL_T(KC_ENT), KC_ENT, /**/ TO(_MOUSE),SPACE_SYW,DEL_LIG, XXXXXXX, XXXXXXX,              XXXXXXX
  ),
  [_ARROWS] = LAYOUT_ortho_4x12(
    ...
    _______, _______, _______, KC_0, S(KC_RBRC), S(KC_DOT), /**/ KC_BTN1, KC_BTN2, LT(_LIGTHS, KC_LEFT), KC_DOWN, KC_UP,   KC_RGHT
  ),
  [_PASSWORDS] = LAYOUT_ortho_4x12(
    ...
    // ├─────┼─────┼─────┼─────┼─────┼─────┤├─────┼─────┼─────┼─────┼─────┼─────┤
    // │ xxx │ xxx │ xxx │Butto│Butto│Butto││     │     │Left │Down │ Up  │Right│
    // │ xxx │ xxx │ xxx │ 3   │ 2   │ 1   ││_NUMB│_QWER│     │     │     │     │
    // └─────┴─────┴─────┴─────┴─────┴─────┘└─────┴─────┴─────┴─────┴─────┴─────┘
  [_MOUSE] = LAYOUT_ortho_4x12(
   ...
   _______, _______, _______, KC_BTN3, KC_BTN2, KC_BTN1,      /**/ TO(_NUMBERS), TG(_MOUSE), KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT
  ),
    // ┌─────┬─────┬─────┬─────┬─────┬─────┐┌─────┬─────┬─────┬─────┬─────┬─────┐
    // │  <  │  >  │  ¿  │  ?  │  [  │  ]  ││  ª  │  ~  │  ^  │  ·  │ xxx │Print│
    // │     │     │     │     │     │     ││  ª  │     │     │     │ xxx │Scree│
  ...
  [_SYMBOLS_M] = LAYOUT_ortho_4x12(
   ...
   _______,      _______,   _______,   ALGR(KC_3), S(KC_0),       S(KC_DOT),     /**/  XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX, XXXXXXX,    XXXXXXX
  ),
  [_SYMBOLS_W] = LAYOUT_ortho_4x12(
   ...
   _______,     S(KC_RBRC),KC_EQL,    S(KC_1),    ALGR(KC_QUOT), ALGR(KC_NUHS), /**/  S(KC_6),    XXXXXXX,    _______,    _______, _______,    _______,
   XXXXXXX,     XXXXXXX,   _______,   ALGR(KC_3), S(KC_0),       S(KC_DOT),     /**/  XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX, XXXXXXX,    XXXXXXX
  ),
    // Numbers y F1-12 LT4
    // ┌─────┬─────┬─────┬─────┬─────┬─────┐┌─────┬─────┬─────┬─────┬─────┬─────┐
    // │ Tab │     │ /   │ (   │ )   │     ││     │     │     │     │     │Bcksp│
    ...
    // ├─────┼─────┼─────┼─────┼─────┼─────┤├─────┼─────┼─────┼─────┼─────┼─────┤
    // │ xxx │ xxx │ xxx │  =  │     │     ││     │     │     │ xxx │ xxx │ xxx │
    // │ xxx │ xxx │ xxx │  0  │  .  │  :  ││_QWER│_QWER│     │ xxx │ xxx │ xxx │
    // └─────┴─────┴─────┴─────┴─────┴─────┘└─────┴─────┴─────┴─────┴─────┴─────┘
  [_NUMBERS] = LAYOUT_ortho_4x12(
   ...
   _______, _______,    _______, KC_0, KC_DOT, S(KC_DOT), /**/ TG(_NUMBERS), TG(_NUMBERS), _______, _______, _______, _______
  ),
    // Ligths & leds LT5
    // ┌─────┬─────┬─────┬─────┬─────┬─────┐┌─────┬─────┬─────┬─────┬─────┬─────┐
